...
| S9 | Slab/punching/diaphragm design | GUI+wire | ◑ Wood-Armer design moments + **required-As contour** (`wood_armer.py`, `areas_reinforcement_mesh`, `ReinforcementDialog`; 23 tests); punching at columns next |
