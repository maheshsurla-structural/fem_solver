...
.. note::
    ...
    **Theme II.7 migration:** the unified Section Designer accesses
    ...
    :func:`femsolver.sections.indian_section` and
    :meth:`femsolver.sections.SectionLibrary.indian`. New user
    ...
    IS 800 design code's internal use.
"""
from __future__ import annotations

from femsolver.data.sections_ec import SectionProperties
